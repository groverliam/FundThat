...
<body>
			...
			<div class="row">
				<div class="col-md-6 hero-text">
					...
					<form class="hero-subscribe-from">
						<button class="site-btn sb-gradients" href="signup.php">Get Started</button>
					</form>
				</div>
				<div class="col-md-6">
		...
		<div class="team-members clearfix">
			...
			<div class="member">
				...
				<div class="member-info">
					...
					<p>Tom Binegar is a full-time faculty member of the Computer Science Division at the Sauder School of Business at UBC. He leads the Entrepreneurship Group, in the undergraduate and graduate programs, teaching actively in both of these.</p>
				</div>
			</div>
			<!-- Team member -->
			<div class="member">
				...
				<div class="member-info">
					...
					<p>Jackson Nash is a full-time faculty member of the Financial Science Division at the Sauder School of Business at UBC. He leads the Entrepreneurship Group, in the undergraduate and graduate programs, teaching actively in both of these.</p>
				</div>
			</div>
			<!-- Team member -->
			<div class="member">
				...
				<div class="member-info">
					...
					<p>Jim Halpert is a full-time faculty member of the Business Science Division at the Sauder School of Business at UBC. He leads the Entrepreneurship Group, in the undergraduate and graduate programs, teaching actively in both of these.</p>
				</div>
			</div>
			<!-- Team member -->
			<div class="member">
				...
				<div class="member-info">
					...
					<p>Melissa Barth is a full-time faculty member of the Marketing and Behavioural Science Division at the Sauder School of Business at UBC. He leads the Entrepreneurship Group, in the undergraduate and graduate programs, teaching actively in both of these.</p>
				</div>
			</div>
			<!-- Team member -->
			<div class="member">
				...
				<div class="member-info">
					...
					<p>Katy Abrams is a full-time faculty member of the Marketing and Behavioural Science Division at the Sauder School of Business at UBC. He leads the Entrepreneurship Group, in the undergraduate and graduate programs, teaching actively in both of these.</p>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="col-lg-8 push-8">
					...
					<div class="review-text-slider owl-carousel">
						<div class="review-text">
							<p>"FUNDTHAT! is exciting because it shows how cheap it can be. FUNDTHAT! is better than currency in that you don’t have to be physically in the same place and, of course, for large transactions, currency can get pretty inconvenient.”</p>
						</div>
						<div class="review-text">
							<p>"FUNDTHAT! is exciting because it shows how cheap it can be. FUNDTHAT! is better than currency in that you don’t have to be physically in the same place and, of course, for large transactions, currency can get pretty inconvenient.”</p>
						</div>
	...
	<section class="blog-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Latest News</h2>
				<p>FUNDTHAT! is the simplest way to save money for the future.</p>
			</div>
			<div class="row">
				<!-- blog item -->
				<div class="col-md-4">
					<div class="blog-item">
						...
						<div class="blog-text">
							<div class="post-date">03 Mar 2019</div>
							<h4 class="blog-title"><a href="">The next recession is coming, are you prepared? Save for the best and worst moments.</a></h4>
							<div class="post-meta">
				...
				<div class="col-md-4">
					<div class="blog-item">
						...
						<div class="blog-text">
							<div class="post-date">28 Feb 2018</div>
							<h4 class="blog-title"><a href="">Blockchain Rolls Out Trading Feature for 22 States in the U.S. Use it to save?</a></h4>
							<div class="post-meta">
								<a href=""><span>by</span> Admin</a>
								<a href=""><i class="fa fa-heart-o"></i> 234 Likes</a>
								<a href=""><i class="fa fa-comments-o"></i> 08 comments</a>
				...
				<div class="col-md-4">
					<div class="blog-item">
						...
						<div class="blog-text">
							<div class="post-date">28 Mar 2019</div>
							<h4 class="blog-title"><a href="">This Week in Money Travel: Up, Down and Sideways. Do you have the funds?</a></h4>
							<div class="post-meta">
								<a href=""><span>by</span> Admin</a>
								<a href=""><i class="fa fa-heart-o"></i> 234 Likes</a>
								<a href=""><i class="fa fa-comments-o"></i> 08 comments</a>
